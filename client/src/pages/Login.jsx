...
import { FaTicketAlt, FaEnvelope, FaLock, FaShieldAlt } from 'react-icons/fa';
...
const s = {
    ...
    cardTop: {
        background: '#0a0a0f', padding: '36px 40px 32px',
    ...
    brandName: {
        fontSize: '22px', fontWeight: 800, color: '#fff', letterSpacing: '-0.3px',
    },
    brandNameAccent: { color: '#a78bfa' },
    heroTitle: {
        fontSize: '26px', fontWeight: 800, color: '#fff',
        marginBottom: '8px', letterSpacing: '-0.5px',
    },
    heroSub: { fontSize: '14px', color: 'rgba(255,255,255,0.5)', fontWeight: 400 },
    ...
    otpHint: {
        ...
        borderRadius: '10px', padding: '12px 16px', marginBottom: '24px',
        fontSize: '13px', textAlign: 'center', display: 'flex',
    ...
    input: {
        ...
        fontSize: '15px', color: '#111', fontFamily: 'inherit',
    ...
    otpInput: {
        ...
        fontSize: '24px', color: '#111', fontFamily: 'monospace',
        outline: 'none', textAlign: 'center', letterSpacing: '10px',
    ...
    divider: {
        ...
        margin: '24px 0', color: '#d1d5db', fontSize: '13px',
    },
    ...
    signupLink: {
        color: '#7c6af7', fontWeight: 700, textDecoration: 'none',
    },
};
...
const Login = () => {
    ...
    const focusStyle = { borderColor: '#7c6af7', boxShadow: '0 0 0 3px rgba(124,106,247,0.12)', background: '#fff' };
            ...
            <div style={s.card}>
                ...
                <div style={s.cardTop}>
                    <div style={s.brandRow}>
                        ...
                        <span style={s.brandName}>Event<span style={s.brandNameAccent}>ora</span></span>
                    </div>
                    <h2 style={s.heroTitle}>{showOTP ? 'Check Your Email' : 'Welcome Back'}</h2>
                    <p style={s.heroSub}>
                        {showOTP ? 'Enter the 6-digit code we sent you' : 'Sign in to your Eventora account'}
                    </p>
                </div>
                ...
                <div style={s.cardBody}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button
                            ...
                            style={{
                                ...s.submitBtn,
                                background: loading ? '#6b7280' : btnHover ? '#1a1a2e' : '#0a0a0f',
                    ...
                    <div style={s.signupRow}>
                        ...
                        <Link to="/register" style={s.signupLink}>Create one free →</Link>
                    </div>
                </div>
            </div>
        </div>
